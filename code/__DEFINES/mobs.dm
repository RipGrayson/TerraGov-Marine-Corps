...
//Decay related defines
#define ORGAN_DESTRUCTION_THRESHOLD 50
#define STANDARD_DECAY_RATE_MIN 0
#define STANDARD_DECAY_RATE_MAX 1
#define ADVANCED_DECAY_RATE_MIN 1
#define ADVANCED_DECAY_RATE_MAX 3
#define TERMINAL_DECAY_RATE_MIN 4
#define TERMINAL_DECAY_RATE_MAX 8
