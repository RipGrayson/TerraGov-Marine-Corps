...
/obj/machinery/computer/shipmanagement
...
/obj/machinery/computer/shipmanagement/ui_interact(mob/user, datum/tgui/ui)
...
/obj/machinery/computer/shipmanagement/ui_data(mob/user)
	scan()
...
/obj/machinery/computer/shipmanagement/ui_act(action, list/params)
	. = ..()
	if(.)
		return
...
/obj/machinery/computer/shipmanagement/proc/scan()
...
/obj/machinery/computer/shipmanagement/proc/add_to_tracked(atom/under)
...
/obj/machinery/computer/shipmanagement/proc/remove_from_tracked(atom/under)
	SIGNAL_HANDLER
	tracked -= under
