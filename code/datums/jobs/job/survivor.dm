/datum/job/survivor
	...
	job_flags = JOB_FLAG_ROUNDSTARTJOINABLE|JOB_FLAG_NOHEADSET
...
Depending on the job you've undertook, you may have additional skills that help or hinder your chances of escape.
