/datum/ai_behavior_nodebased/xeno/zombie
	identifier = IDENTIFIER_ZOMBIE
	base_action = ESCORTING_ATOM
	sidestep_prob = 10

/datum/ai_behavior_nodebased/xeno/zombie/process()
	. = ..()
	var/mob/living/living_parent = mob_parent
	if(living_parent.resting)
		living_parent.get_up()

/datum/ai_behavior_nodebased/xeno/zombie/attack_target(datum/soure, atom/attacked)
...
/datum/ai_behavior_nodebased/xeno/zombie/try_to_heal()
	return //Zombies don't need to do anything to heal

/datum/ai_behavior_nodebased/xeno/zombie/patrolling
	base_action = MOVING_TO_NODE

/datum/ai_behavior_nodebased/xeno/zombie/idle
	base_action = IDLE
